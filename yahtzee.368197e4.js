...
module.exports = h;
},{}],"../Dicebox/preMade.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PreMadeDice = void 0;
...
/*#__PURE__*/
function () {
  function PreMadeDice(name, sidesOnDice) {
    _classCallCheck(this, PreMadeDice);
  ...
  _createClass(PreMadeDice, [{
    ...
    value: function rollDice(diceArea) {
      var diceRoll = (0, _homeOnTheRange.randomInt)(1, this.sidesOnDice);
...
exports.PreMadeDice = PreMadeDice;
},{"home-on-the-range":"../node_modules/home-on-the-range/index.js"}],"preBuiltDiceGames/Yahtzee/yahtzee.js":[function(require,module,exports) {
"use strict";

var _homeOnTheRange = require("home-on-the-range");

var _preMade = require("../../../Dicebox/preMade");
...
function () {
  function Yahtzee() {
    _classCallCheck(this, Yahtzee);
  }

  _createClass(Yahtzee, null, [{
    key: "createDice",
    value: function createDice() {
      var diceArray = ['dicebox1', 'dicebox2', 'dicebox3', 'dicebox4', 'dicebox5'];

      for (var i = 0; i < diceArray.length; i++) {
        diceArray[i] = new _preMade.PreMadeDice("dice".concat(i + 1), 6);
        diceArray[i].create();
      }
    ...
    value: function rollDice() {
      document.querySelector('#yahtzee-button').addEventListener('click', function () {
        var rolls = document.querySelectorAll('.dice-area');
        var _iteratorNormalCompletion = true;
        var _didIteratorError = false;
        var _iteratorError = undefined;

        try {
          for (var _iterator = rolls[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var roll = _step.value;
            roll.textContent = (0, _homeOnTheRange.randomInt)(1, 6);
          }
        } catch (err) {
...
Yahtzee.createDice();
},{"home-on-the-range":"../node_modules/home-on-the-range/index.js","../../../Dicebox/preMade":"../Dicebox/preMade.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","preBuiltDiceGames/Yahtzee/yahtzee.js"], null)
//# sourceMappingURL=/yahtzee.368197e4.js.map